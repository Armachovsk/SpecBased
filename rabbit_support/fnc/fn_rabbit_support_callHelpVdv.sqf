...
[5, [_position], {
    ...
    [_position] spawn {
        ...
        private _supgroup = createGroup [WEST,true];
        for "_i" from 0 to 8 do
        {
        private _unit = _supgroup createUnit [selectRandom[
        ...
        // Создаём вертолёт
        private _heli = createVehicle ["RHS_UH60M_d",  [0,0,300], [], 0, "FLY"];
        ...
        //Сообщаем о вылете
        sleep 10;
        [[], {systemChat "По вашим координатам выслана группа 101-й воздушно-десантной дивизии, ожидайте!";}] remoteExec ["call"];
        ...
        waitUntil{
        sleep 10;
        _player_in_area = allPlayers inAreaArray [getPos _helipad, 500, 500, 100, false];
