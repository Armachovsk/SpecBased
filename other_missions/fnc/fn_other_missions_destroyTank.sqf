...
// done example
// [[200,200,0],"rhsgref_ins_g_t72ba",EAST,1500] execVM "SPEC\other_missions\mission_1\mission_1.sqf";
...
["SPEC_liberation_missionEnd", ["SPEC_other_missions_destroyTank", "SUCCEEDED", _rewards]] call CBA_fnc_serverEvent;
