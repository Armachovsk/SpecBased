...
switch (_p_civ) do {
    case "SpecLib_Faction_Taki_Civilians" : {
        btc_civ_type_units = [
            "SpecLib_c_tk_civ_white_grey_jacket",
            "SpecLib_c_tk_civ_white_grey_coat",
            "SpecLib_c_tk_civ_white_grey_waistcoat",
            "SpecLib_c_tk_civ_brown",
            "SpecLib_c_tk_civ_brown_brown_jacket",
            "SpecLib_c_tk_civ_brown_light_brown_waistcoat",
            "SpecLib_c_tk_civ_cream_grey_jacket",
            "SpecLib_c_tk_civ_cream_grey_coat",
            "SpecLib_c_tk_civ_cream_tricolor_waistcoat",
            "SpecLib_c_tk_civ_olive",
            "SpecLib_c_tk_civ_olive_light_brown_jacket",
            "SpecLib_c_tk_civ_olive_woodland_waistcoat",
            "SpecLib_c_tk_civ_tan_light_brown_jacket",
            "SpecLib_c_tk_civ_tan_desert_waistcoat",
            "SpecLib_c_tk_civ_tan_grey_coat",
            "SpecLib_c_tk_civ_grey_brown_jacket",
            "SpecLib_c_tk_civ_grey_brown_waistcoat",
            "SpecLib_c_tk_civ_grey_black_coat",
            "SpecLib_c_tk_civ_blue",
            "SpecLib_c_tk_civ_blue_brown_coat",
            "SpecLib_c_tk_civ_blue_grey_waistcoat",
            "SpecLib_c_tk_civ_black",
            "SpecLib_c_tk_civ_black_brown_jacket",
            "SpecLib_c_tk_civ_black_brown_waistcoat"
        ];
        btc_civ_type_veh = [
...
//FOB
btc_fob_mat = "B_Slingload_01_Cargo_F";
btc_fob_structure = "US_WarfareBBarracks_Base_EP1";
...
switch (_p_en) do {
    ...
    case "SpecLib_Faction_Taki_Locals" : {
        btc_type_units = [
            "SpecLib_i_tk_gue_autorifleman",
            "SpecLib_i_tk_gue_machinegunner",
            "SpecLib_i_tk_gue_soldier_sniper",
            "SpecLib_i_tk_gue_soldier_rpg7_ammo",
            "SpecLib_i_tk_gue_commander",
            "SpecLib_i_tk_gue_bomber",
            "SpecLib_i_tk_gue_enfield",
            ...
            "SpecLib_i_tk_gue_soldier_rpg7"
        ];
        btc_type_divers = ["O_diver_F"];
        btc_type_crewmen = "SpecLib_i_tk_gue_mechanic";
        btc_type_motorized = [
            "SpecLib_Taki_Gue_uaz_spg9",
            "SpecLib_Taki_Gue_uaz_open",
        ...
        btc_type_mg = [
            ...
            "SpecLib_Taki_Gue_DSHKM_Mini_TriPod"
        ];
        btc_type_gl = [
            "SpecLib_Taki_Gue_AGS30_TriPod",
            "SpecLib_Taki_Gue_dragon",
            "SpecLib_Taki_Gue_SPG9",
            "SpecLib_Taki_Gue_ZU23",
            "SpecLib_Taki_Gue_2b14"
        ];
    };
    case "CPC_O_KAM" : {
        btc_type_units = [
            ...
            "CPC_ME_O_KAM_soldier",
            "CPC_ME_O_KAM_soldier_Officer",
            "CPC_ME_O_KAM_soldier_EXP"
        ];
        btc_type_divers = ["O_diver_F"];
        btc_type_crewmen = "CPC_ME_O_KAM_soldier_crew";
        btc_type_motorized = [
            "CPC_ME_O_KAM_ural_repair",
            "CPC_ME_O_KAM_ural_fuel",
            "CPC_ME_O_KAM_gaz66_ammo",
            "CPC_ME_O_KAM_uh1h_unarmed",
            "CPC_ME_O_KAM_uh1h",
            "CPC_ME_O_KAM_Mi8mt",
            "CPC_ME_O_KAM_Mi8AMT",
            "CPC_ME_O_KAM_ural_open",
            "CPC_ME_O_KAM_ural",
            "VTN_TOYOTA_KADDB",
